...
- **Регистрация "Блупринтов":** Поддерживает как ручную регистрацию `StateMachineBlueprint`, так и автоматическую загрузку из директории, указанной в `BLUEPRINTS_DIR`.
